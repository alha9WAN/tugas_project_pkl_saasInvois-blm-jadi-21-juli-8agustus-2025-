        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <form  class="input-group"  >
                    ...
                    <input name="keyword" type="text" class="form-control"  placeholder="Cari berdasarkan Name">
                    <button class="btn btn-outline-secondary mx-1" type="submit" ><i class="bi bi-search"></i></button>
                        ...
                        <a href="/user/clients" class="btn btn-outline-danger mx-1" type="submit" ><i class="bi bi-x-circle-fill"></i></a>
...
@forelse ($data_client as $item )
       <tr>
                                <td>  <div class="d-flex align-items-center client-avatar" >
                                     <div>{{ $item->id }}</div>
                                    </div> </td>
                                ...
                                <td class="text-end d-flex ">
                                    <a href="/user/clients/{{ $item->id }}/show" class="btn btn-sm btn-outline-primary me-1"><i class="bi bi-eye"></i></a>
