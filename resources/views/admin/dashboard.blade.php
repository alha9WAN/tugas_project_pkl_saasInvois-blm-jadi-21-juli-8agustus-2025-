...
@section('content')
 <div class="dashboard container-fluid mt-2 tex">
    <div class="alert bg-white text-primary shadow-sm">Hallo <span>{{ auth()->user()->name}}</span> Selamat Datang Di Halaman Dashboard Admin</div>
